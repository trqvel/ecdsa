...
def curveNIST256p():
    ...
    G_y = 0x4FE342E2FE1A7F9B8EE7EB4A7C0F9E162CB22C7E39C947D16BD55BEBB1D07A69
...
def addPoint(P, Q, curve):
    ...
    if P[0] == Q[0] and P[1] != Q[1]:
        return (None, None)
    if P != Q:
        lamda = ((Q[1] - P[1]) * inverseModule(Q[0] - P[0], p)) % p
    else:
        lamda = ((3 * P[0]**2 + curve["a"]) * inverseModule(2 * P[1], p)) % p
    x_r = (lamda**2 - P[0] - Q[0]) % p
    y_r = (lamda * (P[0] - x_r) - P[1]) % p
    return (x_r, y_r)
